...
interface IGeoService_IGetGeoRoute
  extends grpc.MethodDefinition<geo_pb.GeoRouteRequest, geo_pb.RouteResponse> {
...
interface IGeoService_IGetAddressRoute
  extends grpc.MethodDefinition<
    geo_pb.AddressRouteRequest,
    geo_pb.RouteResponse
  > {
...
export interface IGeoServer extends grpc.UntypedServiceImplementation {
  ...
  getGeoRoute: grpc.handleUnaryCall<
    geo_pb.GeoRouteRequest,
    geo_pb.RouteResponse
  >
  getAddressRoute: grpc.handleUnaryCall<
    geo_pb.AddressRouteRequest,
    geo_pb.RouteResponse
  >
...
export interface IGeoClient {
  ...
  getGeoRoute(
    request: geo_pb.GeoRouteRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: geo_pb.RouteResponse
    ) => void
  ): grpc.ClientUnaryCall
  getGeoRoute(
    request: geo_pb.GeoRouteRequest,
  ...
  getAddressRoute(
    request: geo_pb.AddressRouteRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: geo_pb.RouteResponse
    ) => void
